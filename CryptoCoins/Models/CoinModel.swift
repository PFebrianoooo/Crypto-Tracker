...
struct CoinModel: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case ath
        case athChangePercentage = "arh_change_percentage"
        case athDate = "ath_date"
        case atl
        case atlChangePercentage = "ath_change_percentage"
    ...
    // untuk update kepemilikan pada portfolio view
    ...
    // untuk valuasi kepemilikan dengan currentPrice Updated pada portfolio
    var currentHoldingValue: Double {
        return (currentHoldings ?? 0)  * currentPrice
    }
    
    // untuk menentukan ranking portfolio
    var rank: Int {
